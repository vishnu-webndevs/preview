...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ className, type = 'text', label, error, helperText, icon, variant = 'default', ...props }, ref) => {
        ...
        <div className="relative">
          <div className="relative">
            ...
            <input
              type={type}
              className={cn(
                'peer w-full h-14 px-4 pt-6 pb-2 text-sm bg-white dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 rounded-xl transition-all duration-200 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-4 focus:ring-blue-500/10 dark:focus:ring-blue-400/10 placeholder-transparent disabled:cursor-not-allowed disabled:opacity-50',
                icon && 'pl-12',
