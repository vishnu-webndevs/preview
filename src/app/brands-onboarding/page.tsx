...
import { BrandInfoStep, ContactInfoStep, PasswordStep, ReviewStep } from './components';
...
export default function BrandOnboarding() {
  ...
  const handleSubmit = async (formData: any) => {
    ...
    try {
      // TODO: Implement API call to register brand
      ...
      router.push('/login?message=Brand registration successful! Please check your email to verify your account.');
    } catch (error) {
  ...
  const steps = [
    {
      ...
      content: (formData: any, updateFormData: any) => (
        <BrandInfoStep formData={formData} updateFormData={updateFormData} errors={errors} />
      )
    },
    {
      title: 'Contact Info',
      ...
      <div className="bg-white rounded-xl shadow-2xl border border-gray-100 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Brand Registration</h2>
              <p className="text-gray-600">Join our platform as a brand</p>
            </div>
          </div>
          <button
            onClick={handleClose}
